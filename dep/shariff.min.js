...
"use strict";module.exports=function(e){var n=encodeURIComponent(e.getURL());return{popup:!0,shareText:{de:"teilen",en:"share"},name:"linkedin",title:{de:"Bei LinkedIn teilen",en:"Share on LinkedIn"},shareUrl:"https://www.linkedin.com/shareArticle?mini=true&url="+n+e.getReferrerTrack()+"&title="+e.getShareText()+"&summary=&source="}};
},{}],6:[function(require,module,exports){
"use strict";module.exports=function(e){return{popup:!1,shareText:"mail",name:"mail",title:{de:"Per E-Mail versenden",en:"Send by email"},shareUrl:"mailto:?body="+encodeURIComponent(e.getURL()+e.getReferrerTrack())+"&subject="+e.getShareText()}};
},{}],7:[function(require,module,exports){
"use strict";module.exports=function(e){var t=encodeURIComponent(e.getURL());return{popup:!0,shareText:{de:"Pin it",en:"Pin it"},name:"pinterest",title:{de:"Bei Pinterest pinnen",en:"Pin it on Pinterest"},shareUrl:"//www.pinterest.com/pin/create/button/?url="+t+e.getReferrerTrack()+"&media="+e.getImageUrl()+"&description="+e.getShareText()}};
},{}],8:[function(require,module,exports){
"use strict";module.exports=function(e){return{popup:!0,shareText:"tweet",name:"twitter",title:{de:"Bei Twitter teilen",en:"Share on Twitter"},shareUrl:"https://twitter.com/intent/tweet?text="+e.getShareText()+"&url="+e.getURL()+e.getReferrerTrack()}};
...
"use strict";module.exports=function(e){var n=encodeURIComponent(e.getURL());return{popup:!0,shareText:{de:"teilen",en:"teilen"},name:"xing",title:{de:"Bei XING teilen",en:"Share on XING"},shareUrl:"//www.xing.com/social_plugins/share?url="+n+e.getReferrerTrack()}};
